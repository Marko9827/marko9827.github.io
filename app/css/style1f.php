...
*/
     ...
     * ::selection, * ::selection {
     ...
     #img_profile_portfolio_cv_pdf:hover {
         box-shadow: 0 7px 35px 0px rgba(0, 0, 0, .1);
     }
     #img_profile_portfolio_cv_pdf:hover:before, #img_profile_portfolio_cv_pdf:hover:after {
         display: block;
         content:'';
         position: absolute;
         width: 250px;
     ...
     #img_profile_portfolio_cv_pdff img:hover {
         border-radius: 15px;
     }
     #img_profile_portfolio_cv_pdff img {
         width: 250px;
         border-radius:300px;
         margin: 10px;
         box-shadow: 0 6px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 70px 0 rgba(0, 0, 0, 0.10);
         margin-left: auto;
         margin-right: auto;
         display: block;
         margin-bottom: 16px;
     }
     #img_profile_portfolio_cv_pdf:hover:after {
         background: #F3CE5E;
     ...
     .switch-label_4:before, .switch-label_4:after {
         content:"";
         position: absolute;
         margin: 0;
         outline: 0;
     ...
     .switch-label_4 .toggle--on_4 {
         display: none;
         border: 0px !important;
         background: transparent;
     }
     .switch-label_4 .toggle--off_4 {
         display: inline-block;
         border: 0px !important;
         background: transparent;
         width: unset;
     }
     .switch-input_4:checked+.switch-label_4:before {
         background-color: rgba(96, 125, 139, 0.80);
     }
     .switch-input_4:checked+.switch-label_4:after {
         background-color: rgba(96, 125, 139, 0.9);
         -ms-transform: translate(80%, -50%);
         -webkit-transform: translate(80%, -50%);
         transform: translate(80%, -50%);
     }
     .switch-input_4:checked+.switch-label_4 .toggle--on_4 {
         display: inline-block;
     }
     .switch-input_4:checked+.switch-label_4 .toggle--off_4 {
         display: none;
     }
     .pass_view {
         position:absolute;
