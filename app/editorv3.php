...
<head>
    ...
    <title>Prilagođeni Video Plejer</title>
...
<body>
    ...
    <main>
        <h1>Moj Prilagođeni Video Plejer</h1>
        
        <video-player-v2 
            data-stream="https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8"
            poster="https://placehold.co/1280x720/000/fff?text=Placeholder+Video">
        </video-player-v2>
        ...
        if (!customElements.get('video-player-v2')) {
            customElements.define('video-player-v2', class extends HTMLElement {
                constructor() {
                    ...
                    this._prevVolume = 1;
                    this.observer = null;
                    // Create the video element once in the constructor
                ...
                attributeChangedCallback(name, oldV, newV) {
                    ...
                    // Only handle source changes from here
                    if (name === 'data-stream') {
                        ...
                        this.img_poster.src = this.getAttribute('poster') || this.getAttribute('data-poster') || '';
                ...
                _setStream(streamUrl) {
                    if (!streamUrl) return;
                    console.log('Setting HLS stream:', streamUrl);
                    ...
                    if (this.video.canPlayType('application/vnd.apple.mpegurl')) {
                        ...
                        if (window.Hls) {
                            ...
                            // The script is already in the head, no need to load it again
                            // Wait for the window.Hls to be available
                ...
                _setMp4(src) {
                    if (!src) return;
                    console.log('Setting MP4 source:', src);
                    if (this._hls) {
                        this._hls.destroy();
                        this._hls = null;
                    }
                ...
                connectedCallback() {
                    // Create and append the DOM once
    ...
    top: -5px;
                        ...
                        /* Novi stilovi za kontekstualni meni */
                        .context-menu {
                          position: fixed;
                    ...
                    // Set poster src based on attribute
                    ...
                    this.contextMenu.innerHTML = `
                        ...
                        <div class="context-menu-item has-submenu" data-action="resolution">
                            Rezolucija
                            <div class="context-submenu hidden">
                                <!-- Opcije rezolucije će biti dinamički dodate ovde -->
                            </div>
                        </div>
                    ...
                    this.shadowRoot.append(style, root, this.video, feedback, this.controlsElement, this.loader, this.contextMenu);
                    ...
                    // Initial load based on attributes
                ...
                _setupEventListeners() {
                    ...
                    this.playerContainer.addEventListener('contextmenu', this._showContextMenu.bind(this));
                    ...
                    // Event listener for play event to hide the poster image
