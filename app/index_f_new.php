...
<body id="fullsc">
  ...
  <ul id="menu">
    ...
    <li data-menuanchor="Map" class="main-nav"> 
      <a onclick="$('#open_info_marko').click()"><i class="fa fa-industry"></i><span>About me
          [IT]</span></a>
...
<iframe id="dotty" width="476" height="757" src="http://localhost:4952/Apps/Eronelit_Maps/"></iframe>
      ...
      <div class="intro">
        ...
        <p class="subtitle text-shadow1">Developer / Photographer <br>From Serbia/Belgrade</p> <a class="color-btn" onclick="OnMap()">See my work [ IT ]</a>
