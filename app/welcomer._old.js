...
"></i></div>
    */
    ...
    ImageBox_div = document.createElement("div");
    ImageBox_div.id = 'zoomImage';
    ImageBox.id = "zoomImage";
    ImageBox_div.style.display = 'none';
    // :
    ...
    zoomWindow.appendChild(ImageBox_div);
    ...
    if (src) {
      ...
      this.shadowRoot
        ...
        .addEventListener("click", (e) => {
          e.preventDefault();
          var box = null;
          if(this.shadowRoot.querySelector("img#zoomImage")){
          box = this.shadowRoot.querySelector("img#zoomImage");
          }
          if(this.shadowRoot.querySelector("div#zoomImage")){
            box = this.shadowRoot.querySelector("div#zoomImage");
          }
