...
<svg xmlns="http://www.w3.org/2000/svg" height="45" width="45" fill="none" class="bi bi-square"
    viewBox="0 0 150 150"
 ...
 "
>
<mask id="myMask">            <circle cx="50" cy="50" r="30" fill="lightgray" stroke="#333" stroke-width="2" />

</mask>
    <path
        d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />

    <svg xmlns='http://www.w3.org/2000/svg' opacity="0.4" width='150' height='150'
        viewBox='0 0 800 800'>
        ...
        <svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
            ...
            <foreignObject x="0" y="0" width="90" height="90">
                <svg mask="url(#myMask)" id="logo_backscr" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                    style="background: rgb(169 169 169) !important;"
                    ...
                    <defs>
                        <radialGradient id="Gradient1" cx="50%" cy="50%" fx="0.441602%" fy="50%"
                            r=".5">
                        ...
                        <radialGradient id="Gradient2" cx="50%" cy="50%" fx="2.68147%" fy="50%"
                            r=".5">
                        ...
                        <radialGradient id="Gradient3" cx="50%" cy="50%" fx="0.836536%" fy="50%"
                            r=".5">
                        ...
                        <radialGradient id="Gradient4" cx="50%" cy="50%" fx="4.56417%" fy="50%"
                            r=".5">
                        ...
                        <radialGradient id="Gradient5" cx="50%" cy="50%" fx="2.65405%" fy="50%"
                            r=".5">
                        ...
                        <radialGradient id="Gradient6" cx="50%" cy="50%" fx="0.981338%" fy="50%"
                            r=".5">
                    ...
                    <rect x="13.744%" y="1.18473%" width="100%" height="100%" fill="url(#Gradient1)"
                        ...
                        <animate attributeName="x" dur="20s" values="25%;0%;25%"
                            repeatCount="indefinite"></animate>
                        <animate attributeName="y" dur="21s" values="0%;25%;0%"
                            repeatCount="indefinite"></animate>
                        <animateTransform attributeName="transform" type="rotate" from="0 50 50"
                            to="360 50 50" dur="7s" repeatCount="indefinite"></animateTransform>
                    </rect>
                    <rect x="-2.17916%" y="35.4267%" width="100%" height="100%"
                        fill="url(#Gradient2)" transform="rotate(255.072 50 50)">
                        <animate attributeName="x" dur="23s" values="-25%;0%;-25%"
                            repeatCount="indefinite"></animate>
                        <animate attributeName="y" dur="24s" values="0%;50%;0%"
                            repeatCount="indefinite"></animate>
                        <animateTransform attributeName="transform" type="rotate" from="0 50 50"
                            to="360 50 50" dur="12s" repeatCount="indefinite"></animateTransform>
                    </rect>
                    <rect x="9.00483%" y="14.5733%" width="100%" height="100%"
                        fill="url(#Gradient3)" transform="rotate(139.903 50 50)">
                        <animate attributeName="x" dur="25s" values="0%;25%;0%"
                            repeatCount="indefinite"></animate>
                        <animate attributeName="y" dur="12s" values="0%;25%;0%"
                            repeatCount="indefinite"></animate>
                        <animateTransform attributeName="transform" type="rotate" from="360 50 50"
                            to="0 50 50" dur="9s" repeatCount="indefinite"></animateTransform>
                    </rect>
                </svg>
            </foreignObject>
        </svg>
...
?>
   <!-- <img id="sourceImg" src="/?svc=p&id=<?php echo $_GET['id']; ?>" alt="Image to Convert"> -->
...
<body>
    <div class="svg-container">
        <div class="share"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-share" viewBox="0 0 16 16">
...
<image  href="<?php echo "$contentType[thumbail]"; ?>" opacity="0.7" preserveAspectRatio="xMidYMid slice" width="100%" height="100%"/>
<defs>
  ...
  transform="translate(-23.5, -100)" x="50%" y="50%" text-anchor="middle" dominant-baseline="middle"
  href="<?php echo "/?svc=logo";?>" mask="url(#roundedMask)"/> 
  
 
  <text pointer-events="none" fill="white" x="50%" y="50%" text-anchor="middle" dominant-baseline="middle" font-family="Arial" font-size="20">
