...
function menu_theme_red()
{
    ...
    document.getElementById("template_css").href="red_template/style1f.css";
...
function menu_theme_green()
{
    ...
    document.getElementById("template_css").href="green_template/style1f.css";
    document.getElementById("F_slider_projcts").src = "red_template/projct.html";
...
function menu_theme_gold(){
    ...
    document.getElementById("template_css").href="css/style1f.css"; 
}

function menu_theme_blue(){
    opts.colors = ['rgba(0, 134, 196,alp)', 'rgba(51, 122, 183,alp)', 'rgba(255,255,255,alp)'];
    document.getElementById("template_css").href="blue_template/style1f.css"; 
}