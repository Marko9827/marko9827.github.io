...
button{border:0px;padding: 7px;margin-left: auto;margin-right: auto;display: block;margin-top: 10px;box-shadow: 0 0px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 70px 0 rgba(0, 0, 0, 0.10);color: currentColor;background: #337ab7;text-align: center;margin-bottom: 10px;text-transform: uppercase;border: 2px dashed;border-radius: 10px;font-size: 13px;}
button:hover{
background:#337ab7;
color:white;
}
...
#alert{
 ...
 #alert p{
     ...
     width: max-content;
     background: white;
     box-shadow: 0 0px 8px 0 #f00a, 0 6px 3077px 0 #337ab700;
 }
...
#left_coll .separator{
    position:absolute;
    width: -webkit-fill-available;
    box-shadow: 0 0px 4px 0 #337ab7c7, 0 6px 3077px 0 #337ab700;
}
